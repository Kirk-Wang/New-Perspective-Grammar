...
(2006, Use of English)
尽管数字可能会变化，这些分析学家确实同意了另外一些事儿。

But science `does provide` us with the best
available guide to the future...
(2005, Reading Comprehension, Part A Text 2)
科学确实提供给我们最好的可能性的引导去通向未来
`does provide` :确实提供，表示现在
science 是单数，所以用单三形式 does

The court `did suggest` that accpeting favors in
return  for opening doors is "distasteful" and "nasty."
(2017, Reading Comprehension, Part A Text 4)
这个法院确实指明这样一件事儿--接受好处作为开后门的回报
是不光彩的肮脏的。
