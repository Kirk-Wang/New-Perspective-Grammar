...
* be used to doing sth. 习惯于某事(过去习惯，现在习惯)

take charge of -> 照顾

2. I `am used to` traveling by air... 我已经习惯了坐飞机✈️。
...
4. After taking off, we were `flying flow over the city` and slowly `gaining height`, when the plane suddenly `turned round` and `flew back to the airport`.
* we were flying... 过去进行时
* ... and slowly... 并列句，相同的省略
* when... 时间状语从句
...
be curious to do... 好奇的去做某事……

we were curious to find out what had happened.
* 动宾，宾语从句

6. Later we learnt that `there was a very important person on board`.
* there was ...典型的 there be 句型

**there be 句型都是倒装句，全部倒装**

**very important person --> VIP**

had been told -> 过去的之前被告知
